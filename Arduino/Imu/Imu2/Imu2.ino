...
//  printHeading((float) dof.mx, (float) dof.my, (float) dof.mz);
  printHeading((float) dof.calcMag(dof.mx), (float) dof.calcMag(dof.my), (float) dof.calcMag(dof.mz));
...
void printGyro()
{
  ...
  printFloats(dof.calcGyro(dof.gx), dof.calcGyro(dof.gy), dof.calcGyro(dof.gz));
#elif defined PRINT_RAW
  printFloats(dof.gx, dof.gy, dof.gz);
#endif
}
...
void printAccel()
{
  ...
  printFloats(dof.calcAccel(dof.gx), dof.calcAccel(dof.gy), dof.calcAccel(dof.gz));
#elif defined PRINT_RAW 
  printFloats(dof.gx, dof.gy, dof.gz);
#endif
...
void printMag()
{
  ...
  printFloats(dof.calcMag(dof.gx), dof.calcMag(dof.gy), dof.calcMag(dof.gz));
#elif defined PRINT_RAW
  printFloats(dof.gx, dof.gy, dof.gz);
#endif
}
...
{
  float heading = calcHeading(hx, hy);
